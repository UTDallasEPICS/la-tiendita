...
- The admin can create new surveys

# Third-party intergration

The only third-party intergration this application has used is [OAuth 2](https://auth0.com/intro-to-iam/what-is-oauth-2) for login.
